$(document).ready(function () {
    ...
    function n(e) {
        $(e).block({
            ...
            css: {border: "none", padding: "0px", width: "20px", height: "20px", backgroundColor: "transparent"},
            overlayCSS: {backgroundColor: "#fff", opacity: .9, cursor: "wait"}
        })
    }
    ...
    $(".show-search").click(function () {
        ...
        e()
    }), Waves.displayEffect(), $('[data-toggle~="tooltip"]').tooltip({container: "body"});
    ...
    //        {
    //            var e = $(".sidebar .menu"), n = ($(".page-sidebar-inner"), $(".page-content"), $(this).next());
    //            $(this)
    //        }
    ...
    //}),
        ...
        {
            var e = $(this).parent().parent(), n = ($(".page-sidebar-inner"), $(".page-content"), $(this).next());
            $(this)
        }
    ...
    var o = function () {
        {
            var e, n = $(".page-inner"), a = $(".page-sidebar"), s = $("body"), i = $(".page-footer").outerHeight();
            $(".page-content").height()
        }
    ...
    o(), window.onresize = o, $(".slimscroll").slimscroll({allowPageScroll: !0});
    var t = document.querySelector(".fixed-header-check"), c = document.querySelector(".fixed-sidebar-check"), l = document.querySelector(".toggle-sidebar-check"), r = document.querySelector(".compact-menu-check"), d = function () {
    ...
    }, h = $(".navbar .logo-box a span").text(), u = h.slice(0, 1), m = function () {
        ...
        !$("body").hasClass("page-horizontal-bar") || $("body").hasClass("page-sidebar-fixed") || $("body").hasClass("page-header-fixed") || (t.click(), alert("Fixed horizontal nav isn't compatible with static header mode. Modern will set fixed mode on header.")), $("body").hasClass("hover-menu") && !$("body").hasClass("page-sidebar-fixed") && (hoverMenuCheck.click(), alert("Fixed sidebar isn't compatible with hover menu mode. Modern will set accordion mode on menu.")), $("body").toggleClass("page-sidebar-fixed"), $("body").hasClass(".page-sidebar-fixed") && $(".page-sidebar-inner").slimScroll({destroy: !0}), $(".page-sidebar-inner").slimScroll(), o()
    }, g = function () {
    ...
    if ($(".page-sidebar-fixed .page-sidebar-inner").slimScroll(), $(".small-sidebar .navbar .logo-box a span").html($(".navbar .logo-box a span").text() == u ? h : u), $(".theme-settings").length || $(".sidebar-toggle").click(function () {
        ...
        {
            var f = document.getElementById("cbp-spmenu-s1"), k = document.getElementById("showRight"), y = document.getElementById("closeRight"), v = document.getElementById("cbp-spmenu-s2"), x = document.getElementById("closeRight2");
            document.body
        }
        k.onclick = function () {
            ...
            if (13 == e.which && 0 == !$(this).val().length)$('<div class="chat-item chat-item-right"><div class="chat-message">' + $(this).val() + "</div></div>").insertAfter(".chat .chat-item:last-child"), $(this).val(""); else if (13 == e.which)return;
